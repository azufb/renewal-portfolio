        ...
        return (
            <div className="detailContents">
                ...
                <div className="contentsBox">
                    ...
                    <p>
                        そんな毎日の作業をちょっと楽しくできるのがこのアプリです！いつも通りタスクを完了していき、1日の終わりに全てのタスクをALL DONE！すると、皆さんの頑張りを労ってもらえます！
                    </p>
                    <p>
                        明日も頑張るために、今日の自分を労ってみませんか？？
                    </p>
                </div>
                ...
                <div className="contentsBox">
                    ...
                    <div className="videoBox">
                        <video src={todokanriVideo} controls className="video" controlsList="nodownload"></video>
                    </div>
                    <div className="appLink">
                        <p>
                            <a href="https://todokanri.netlify.app/" target='_blank' rel='noopener noreferrer'>使ってみる！<i className="fas fa-external-link-alt"></i></a>
                        </p>
                    </div>
                </div>
