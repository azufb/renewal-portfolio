            ...
            <div className="detailContents">
                ...
                <div className="contentsBox">
                    ...
                    <div className="videoBox">
                        <video src={negapuchiVideo} controls className="video" controlsList="nodownload"></video>
                    </div>
                    <div className="appLink">
                        <p>
                            <a href="https://negapuchi.netlify.app/" target='_blank' rel='noopener noreferrer'>使ってみる！<i className="fas fa-external-link-alt"></i></a>
                        </p>
                    </div>
                </div>
