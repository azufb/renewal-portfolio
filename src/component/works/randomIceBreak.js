            ...
            <div className="detailContents">
                ...
                <div className="contentsBox">
                    ...
                    <div className="videoBox">
                        <video src={icebreakshuffleVideo} controls className="video" controlsList="nodownload"></video>
                    </div>
                    <div className="appLink">
                        <p>
                            <a href="https://random-ice-break.vercel.app/" target='_blank' rel='noopener noreferrer'>使ってみる！<i className="fas fa-external-link-alt"></i></a>
                        </p>
                    </div>
                </div>
                ...
                <div className="contentsBox">
                    ...
                    <p>
                        <a href="https://github.com/azufb/randomIceBreak" target='_blank' rel='noopener noreferrer'>
